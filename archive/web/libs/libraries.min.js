...
/*
 *  Plugins - directionReveal.js
 */
!function(){if("function"==typeof NodeList.prototype.forEach)return!1;NodeList.prototype.forEach=Array.prototype.forEach,String.prototype.startsWith||Object.defineProperty(String.prototype,"startsWith",{enumerable:!1,configurable:!1,writable:!1,value:function(e,t){return t=t||0,this.indexOf(e,t)===t}})}(),function e(t,r,n){function o(a,u){if(!r[a]){if(!t[a]){var c="function"==typeof require&&require;if(!u&&c)return c(a,!0);if(i)return i(a,!0);var f=new Error("Cannot find module '"+a+"'");throw f.code="MODULE_NOT_FOUND",f}var l=r[a]={exports:{}};t[a][0].call(l.exports,function(e){var r=t[a][1][e];return o(r||e)},l,l.exports,e,t,r,n)}return r[a].exports}for(var i="function"==typeof require&&require,a=0;a<n.length;a++)o(n[a]);return o}({1:[function(e,t,r){"use strict";Object.defineProperty(r,"__esModule",{value:!0});r.default=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=e.selector,r=void 0===t?".direction-reveal":t,o=e.itemSelector,i=void 0===o?".direction-reveal__card":o,a=e.animationName,u=void 0===a?"swing":a,c=e.enableTouch,f=void 0===c||c,l=e.touchThreshold,d=void 0===l?250:l,s=document.querySelectorAll(r),v=void 0,h=function(e){for(var t=0,r=0;e;)t+=e.offsetLeft+e.clientLeft,r+=e.offsetTop+e.clientTop,e=e.offsetParent;return{x:t,y:r}},p=n({0:"top",1:"right",2:"bottom",3:"left"})("top"),m=function(e,t){var r=e.currentTarget,n=function(e,t){var r=t.offsetWidth,n=t.offsetHeight,o=h(t),i=e.pageX-o.x-r/2*(r>n?n/r:1),a=e.pageY-o.y-n/2*(n>r?r/n:1);return Math.round(Math.atan2(a,i)/1.57079633+5)%4}(e,r),o=p(n),i=r.className.split(" ").filter(function(e){return!e.startsWith(u)}).join(" ");r.className=i,r.classList.add(u+"--"+t+"-"+o)},y=function(e,t,r){t.forEach(function(t){return e.addEventListener(t,r)})},g=function(){s.length&&s.forEach(function(e){!function(e){e.querySelectorAll(i).forEach(function(e){y(e,["mouseenter","focus"],function(e){m(e,"in")}),y(e,["mouseleave","blur"],function(e){m(e,"out")}),f&&(e.addEventListener("touchstart",function(e){v=+new Date}),e.addEventListener("touchend",function(t){+new Date-v<d&&null===e.getAttribute("data-hover")&&(t.preventDefault(),e.setAttribute("data-hover","true"),m(t,"in"))}))})}(e)})};return g(),{init:g}};var n=r.switchcase=function(e){return function(t){return function(r){return r in e?e[r]:t}}}},{}],2:[function(e,t,r){"use strict";var n,o=e("./direction-reveal.js"),i=(n=o)&&n.__esModule?n:{default:n};(0,i.default)({selector:".direction-reveal--demo-swing"}),(0,i.default)({selector:".direction-reveal--demo-slide",itemSelector:".direction-reveal__card",animationName:"slide",enableTouch:!0}),(0,i.default)({selector:".direction-reveal--demo-rotate",animationName:"rotate"}),(0,i.default)({selector:".direction-reveal--demo-bootstrap"})},{"./direction-reveal.js":1}]},{},[2]);
