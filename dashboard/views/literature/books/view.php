...
<div class="publication-view">
    <p>
        ...
        <?= Html::a(Yii::t('app', 'Добавить PDF'), ['/attachments/create', 't' => \common\enums\AttachmentsEnum::TYPE_PDF, 'rt' => \common\enums\AttachmentsEnum::RELATION_PUBLICATION, 'rid' => $model->id, 'path' => 'a', 'rUrl' => '/literature/books/view?id='.$model->id], ['class' => 'btn btn-primary']) ?>
    </p>
