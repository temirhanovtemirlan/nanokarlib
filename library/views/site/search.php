...
/* @var $dataProvider common\filters\PublicationFilter */
/* @var $models common\models\Publication[] */

$this->title = Yii::t('app', 'Поиск по разделам');
                ...
                <?php foreach ($models as $key => $model): ?>
                    <div class="card">
                        ...
                        <div class="collapse <?= ($key != 0) ?: 'show' ?>" id="collapse<?= $key ?>" data-parent="#accordion">
                            <div class="card-body">
                                <p><?= $model->announce ?></p>
                                <a class="btn submit" href="<?= \yii\helpers\Url::to(['/site/publication', 'canonical_title' => $model->canonical_title]) ?>">
                                    <?= Yii::t('app', 'Подробнее') ?>
                                </a>
                            </div>
                        </div>
